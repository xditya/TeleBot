...
async def start_all(event):
    if from_users = OWNER:
        ...
        await tgbot.send_message(event.chat_id,
                                startotherdis,
                                buttons = [(Button.url("TeleBot", url="https://github.com/xditya/TeleBot"))]
        )
...
async def owner(event):
    await tgbot.send_message(event.chat_id,
                        ...
                        buttons = [
                            ...
                            [custom.Button.inline("Settings ⚙️", data="settings")]
                        ])
...
async def settings(event):
    ...
    await tgbot.send_message(event.chat_id,
            ...
            buttons = [
                ...
                [Button.url("Logs", url=f"https://t.me/{Var.TG_BOT_USER_NAME_BF_HER}?start=logs")]
            ])
