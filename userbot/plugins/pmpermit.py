...
if PMPIC is None:
  WARN_PIC = "https://telegra.ph/file/9073fd6441c38a3dfbc51.mp4"
else:
  WARN_PIC = PMPIC

PREV_REPLY_MESSAGE = {}
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "TeleBot User"
USER_BOT_WARN_ZERO = "`You were spamming my inbox, henceforth you have been blocked by Plus+ UserBot.` "
USER_BOT_NO_WARN = ("**Welcome to TeleBot"
                    "PM Permit Security**\n\n"
                    "**This is an automated message in  "
                    f"{DEFAULTUSER}'s Inbox to prevent spammers.**\n\n"
                    f"{MESAG}")
