...
USER_BOT_WARN_ZERO = "`I warned you not to spam, you have now been blocked and reported, until further notice.` "
USER_BOT_NO_WARN = ("`Hello ! This is` **TeleBot**\n"
                    "`PM Permit Security`\n\n"
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
          if chat.id == 719195224:
            await event.edit("You blocked my creator, now goodbye for 100 seconds")
