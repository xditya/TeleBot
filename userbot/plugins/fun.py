...
@borg.on(outgoing=True, pattern="^-_-$")
async def lol(lel):
    """ Ok... """
    okay = "-_-"
    for i in range(10):
...
@borg.on(outgoing=True, pattern="^!(yes|no|maybe|decide)$")
...
@borg.on(outgoing=True, pattern="^!fp$")
async def facepalm(e):
    """ Facepalm  🤦‍♂ """
    await e.edit("🤦‍♂")


@borg.on(outgoing=True, pattern="^!cry$")
async def cry(e):
    """ y u du dis, i cry everytime !! """
    await e.edit(choice(CRI))


@borg.on(outgoing=True, pattern="^!abuse$")
async def insult(e):
    """ I make you cry !! """
    await e.edit(choice(INSULT_STRINGS))


@borg.on(outgoing=True, pattern="^!cp(?: |$)(.*)")
...
@borg.on(outgoing=True, pattern="^!vapor(?: |$)(.*)")
async def vapor(vpr):
    """ Vaporize everything! """
    reply_text = list()
...
@borg.on(outgoing=True, pattern="^!str(?: |$)(.*)")
...
@borg.on(outgoing=True, pattern="^!style(?: |$)(.*)")
async def zal(zgfy):
...
@borg.on(outgoing=True, pattern="^!hi$")
async def hoi(hello):
    """ Greet everyone! """
    await hello.edit(choice(HELLOSTR))


@borg.on(outgoing=True, pattern="^!owo(?: |$)(.*)")
async def faces(owo):
    """ UwU """
...
@borg.on(outgoing=True, pattern="^!react$")
async def react_meme(react):
    """ Make your userbot react to everything. """
    await react.edit(choice(FACEREACTS))


@borg.on(outgoing=True, pattern="^!iwi(?: |$)(.*)")
...
@borg.on(outgoing=True, pattern="^!shg$")
...
@borg.on(outgoing=True, pattern="^Oof$")
async def Oof(e):
    t = "Oof"
    for j in range(15):
        t = t[:-1] + "of"
...
@borg.on(outgoing=True, pattern="^!kill$")
async def iqless(e):
...
@borg.on(outgoing=True, pattern="^!bye$")
async def iqless(e):
    await e.edit("Kek thx bye")       
                      

@borg.on(outgoing=True, pattern="^!moon$")
...
@borg.on(outgoing=True, pattern="^!earth$")
...
@borg.on(outgoing=True, pattern="^!clock$")
...
@borg.on(outgoing=True, pattern="^!rain$")
...
@borg.on(outgoing=True, pattern="^!love$")
...
@borg.on(outgoing=True, pattern="^!mock(?: |$)(.*)")
...
@borg.on(outgoing=True, pattern="^!clap(?: |$)(.*)")
...
@borg.on(outgoing=True, pattern="^!bt$")
...
@borg.on(outgoing=True, pattern=r"^!f (.*)")
...
@borg.on(outgoing=True, pattern="^!ggl (.*)")
...
@borg.on(pattern=r"!scam(?: |$)(.*)", outgoing=True)
...
@borg.on(outgoing=True, pattern="^.fail$")
async def fail(e):
...
@borg.on(outgoing=True, pattern="^.lool$")
async def lool(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╭╭━━━╮╮┈┈┈┈┈┈┈┈┈┈\n┈┃╭━━╯┈┈┈┈▕╲▂▂╱▏┈\n┈┃┃╱▔▔▔▔▔▔▔▏╱▋▋╮┈`"
                     "`\n┈┃╰▏┃╱╭╮┃╱╱▏╱╱▆┃┈\n┈╰━▏┗━╰╯┗━╱╱╱╰┻┫┈\n┈┈┈▏┏┳━━━━▏┏┳━━╯┈`"
...
@borg.on(outgoing=True, pattern="^.nih$")
async def nih(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n(\_/)`"
                     "`\n(•_•)`"
...
@borg.on(outgoing=True, pattern="^.hello$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n█████████`" 
                     "`\n█▄█████▄█`"    
...
@borg.on(outgoing=True, pattern="^.ml(?: |$)(.*)")
async def gtfo(e):
...
@borg.on(outgoing=True, pattern="^.taco$")  
async def taco(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n{\__/}"
                     "\n(●_●)"
...
@borg.on(outgoing=True, pattern="^.paw$")  
async def paw(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@borg.on(outgoing=True, pattern="^.tf$")  
async def tf(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")  
       
                  
@borg.on(outgoing=True, pattern="^.gey$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@borg.on(outgoing=True, pattern="^.gay$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@borg.on(outgoing=True, pattern="^.bot$")
async def bot(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("` \n   ╲╲╭━━━━╮ \n╭╮┃▆┈┈▆┃╭╮ \n┃╰┫▽▽▽┣╯┃ \n╰━┫△△△┣━╯`"
                     "`\n╲╲┃┈┈┈┈┃  \n╲╲┃┈┏┓┈┃ `")
...
@borg.on(outgoing=True, pattern="^.hey$")
async def hey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n┈┈┈╱▔▔▔▔╲┈╭━━━━━\n┈┈▕▂▂▂▂▂▂▏┃HEY!┊😀`"
                     "`\n┈┈▕▔▇▔▔┳▔▏╰┳╮HEY!┊\n┈┈▕╭━╰╯━╮▏━╯╰━━━\n╱▔▔▏▅▅▅▅▕▔▔╲┈┈┈┈`"
...
@borg.on(outgoing=True, pattern="^.nou$")
async def nou(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈╭╮╭╮\n┈┃┃┃┃\n╭┻┗┻┗╮`"
                     "`\n┃┈▋┈▋┃\n┃┈╭▋━╮━╮\n┃┈┈╭╰╯╰╯╮`"
...
@borg.on(outgoing=True, pattern="^.mf$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
"\n......................................../´¯/) "
...
@borg.on(outgoing=True, pattern="^!sayhi$")
async def shalom(e):
    await e.edit(
        "\n💛💛💛💛💛💛💛💛💛"
        "\n💛🔷🔷🔷🔷🔷🔷🔷💛"
...
@borg.on(outgoing=True, pattern="^!call(?: |$)(.*)")
...
async def _(event):
   ...
   # if input_str == "call":
    ...
    animation_chars = [
            ...
            "`Me: Yo this is` @borg.on ,`Please Connect me to my lil bro,lel`",
            "`User Authorised.`",
...
@borg.on(outgoing=True, pattern="^!logic(?: |$)(.*)")
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!fry(?: |$)(.*)")
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!fry2(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return 
...
@borg.on(outgoing=True, pattern="^!instant(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(outgoing=True, pattern="^!play$")
...
@borg.on(outgoing=True, pattern="^!ding$")
...
@borg.on(outgoing=True, pattern="^!leave$")
async def leave(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`You must Leaving dis Group kek!`")


@borg.on(outgoing=True, disable_errors=True, pattern="^!wtf$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!whack$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!snake$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!soler$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!think$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!hack$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!bomb(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!sad(?: |$)(.*)")
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!play1$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!play2$")
async def _(event):
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!play3$")
async def _(event):
...
@borg.on(outgoing=True, pattern="^!moon2$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("🌕🌕🌕🌕🌕🌕🌕🌕\n🌕🌕🌖🌔🌖🌔🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌖🌓🌗🌔🌕🌕\n🌕🌕🌗🌑🌑🌓🌕🌕\n🌕??🌗👀🌑🌓🌕🌕\n🌕??🌘👄🌑🌓🌕🌕\n🌕🌕🌗????🌒🌕🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌕🌘🌑🌑🌑🌑🌒🌕\n🌖🌑🌑🌑🌑🌑🌑🌔\n🌕🤜🏻🌑🌑🌑🌑🤛🏻🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌘🌑🌑🌑🌑🌑🌑🌒\n🌕🌕🌕🌕🌕🌕🌕🌕")

@borg.on(outgoing=True, pattern="^!city$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("""☁☁🌞      ☁           ☁
...
@borg.on(outgoing=True, pattern="^!cheer$")
async def cheer(event):
    if event.fwd_from:
        return
    await event.edit("💐💐😉😊💐💐\n☕ Cheer Up  🍵\n🍂 ✨ )) ✨  🍂\n🍂┃ (( * ┣┓ 🍂\n🍂┃*💗 ┣┛ 🍂 \n🍂┗━━┛  🍂🎂 For YOU  🍰\n💐💐😌😚💐💐")

@borg.on(outgoing=True, pattern="^!getwell$")
async def getwell(event):
    if event.fwd_from:
        return
    await event.edit("🌹🌹🌹🌹🌹🌹🌹🌹 \n🌹😷😢😓😷😢💨🌹\n🌹💝💉🍵💊💐💝🌹\n🌹 GetBetter Soon! 🌹\n🌹🌹🌹🌹🌹🌹🌹🌹")

@borg.on(outgoing=True, pattern="^!luck$")
async def luck(event):
    if event.fwd_from:
        return
    await event.edit("💚~🍀🍀🍀🍀🍀\n🍀╔╗╔╗╔╗╦╗✨🍀\n🍀║╦║║║║║║👍🍀\n🍀╚╝╚╝╚╝╩╝。 🍀\n🍀・・ⓁⓊⒸⓀ🍀\n🍀🍀🍀 to you💚")

@borg.on(outgoing=True, pattern="^!love2$")
...
@borg.on(outgoing=True, disable_errors=True, pattern="^!nakal$")
...
@borg.on(outgoing=True, pattern="^!police$")
...
@borg.on(outgoing=True, pattern=r"^\!(?:penis|dick)\s?(.)?")
...
@borg.on(outgoing=True, pattern="^!noob$")
async def insult(e):
    """ I make you cry !! """
    await e.edit(choice(NOOBSTR))


@borg.on(outgoing=True, pattern="^!abuse2$")
async def insult(e):
    """ I make you cry !! """
...
@borg.on(outgoing=True, pattern="^!abuse3$")
