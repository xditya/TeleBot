...
from userbot import AUTOPIC_TEXT, AUTO_PIC_FONT, AUTOPIC_FONT_COLOUR

fntz = str(AUTO_PIC_FONT) if AUTO_PIC_FONT else "DejaVuSans.ttf"
FONT_FILE_TO_USE = f"fonts/{fntz}"
AUTOPIC_TEXT = str(AUTOPIC_TEXT) if AUTOPIC_TEXT else "Life Is too Short.\n And so is your TG account."
...
async def autopic(event):
	...
	downloader = await telebot.download_media(a, downloaded_file_name)
